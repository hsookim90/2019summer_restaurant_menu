...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Voting Idea</title>
  	...
  	<!-- <link rel="stylesheet" type="text/css" href="css/MenuDesktop.css"> -->
		<link media="screen and (min-width: 1000px)" rel="stylesheet" href="css/MenuDesktop.css">
		<link media="screen and (max-width: 999px)" rel="stylesheet" href="css/style.css">
